...
- **Apple Silicon Mac:** download `TeXGlot-1.1.0-macOS-arm64.dmg`, open it, drag TeXGlot into Applications and launch TeXGlot.
- **Intel Mac:** use `TeXGlot-1.1.0-macOS-x64.dmg` when attached to the release.
- **Windows x64:** use `TeXGlot-1.1.0-Windows-x64-Setup.exe` when attached to the release. The installer runs for the current user and creates Start menu and desktop shortcuts; administrator access is not required.
