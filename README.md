...
<p align="center">
  <a href="#quick-start">Quick start</a> · <a href="#example-attention-is-all-you-need">Example</a> · <a href="#command-line">CLI</a> · <a href="CONTRIBUTING.md">Contributing</a> · <a href="docs/releases/v1.1.1.md">Release notes</a>
</p>
...
| :--- | :--- | :--- |
| Mac · Apple Silicon | `TeXGlot-1.1.1-macOS-arm64.dmg` | Open and drag into Applications |
| Mac · Intel | `TeXGlot-1.1.1-macOS-x64.dmg` | Open and drag into Applications |
| Windows · x64 | `TeXGlot-1.1.1-Windows-x64-Setup.exe` | Run setup and open the desktop shortcut |
...
Download and extract **`texglot-1.1.1-source.zip`** from [Releases](https://github.com/Mengqi-Lei/texglot/releases), or clone the repository:
