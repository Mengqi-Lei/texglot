...
<p align="center">
  <a href="#快速开始">快速开始</a> · <a href="#案例attention-is-all-you-need">案例</a> · <a href="#命令行">CLI</a> · <a href="CONTRIBUTING_CN.md">参与贡献</a> · <a href="docs/releases/v1.1.1_CN.md">版本说明</a>
</p>
...
| 电脑 | 安装包 | 使用方式 |
| :--- | :--- | :--- |
| Mac · Apple Silicon | `TeXGlot-1.1.1-macOS-arm64.dmg` | 打开后拖入 Applications |
| Mac · Intel | `TeXGlot-1.1.1-macOS-x64.dmg` | 打开后拖入 Applications |
| Windows · x64 | `TeXGlot-1.1.1-Windows-x64-Setup.exe` | 双击安装，打开桌面快捷方式 |
...
从 [Releases](https://github.com/Mengqi-Lei/texglot/releases) 下载并解压 **`texglot-1.1.1-source.zip`**，或克隆仓库：
